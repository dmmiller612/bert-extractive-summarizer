...
setup(name='bert-extractive-summarizer',
      ...
      download_url='https://github.com/dmmiller612/bert-extractive-summarizer/archive/0.2.2.tar.gz',
      author='Derek Miller',
      author_email='dmmiller612@gmail.com',
      install_requires=['transformers', 'scikit-learn', 'neuralcoref', 'spacy==2.1.3'],
      license='MIT',
